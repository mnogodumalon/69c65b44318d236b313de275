...
import { fetchActionsAndFiles, executeAction, deleteAction as deleteActionApi, agentChat, downloadFile } from '@/lib/actions-agent';
...
export function ActionsProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ActionsContext.Provider
      value={{ actions, chatOpen, setChatOpen, messages, chatLoading, runAction, sendMessage, devMode, setDevMode, showActionCode, deleteAction: deleteActionFn, inputFormAction, inputFormOptions, submitActionInputs, cancelInputForm, files, downloadFile }}
    >
      {children}
    </ActionsContext.Provider>
  );
